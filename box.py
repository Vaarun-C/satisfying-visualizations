...
SAMPLING_RATE = 44100
DURATION = 0.2  # Adjust duration for a more pleasant sound
...
def draw_window():
    ...
    new_color = new_colour(COLOUR)

    if new_color != COLOUR:
        freq = random.randint(200, 600)  # Adjust the frequency range for a pleasant sound
